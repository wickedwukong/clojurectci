...
(defn- merge_in_descending_order [current_a remaining_a current_b remaining_b merged_results]
	(cond 
...
(defn merge_sorted [sorted_a sorted_b] 
	(reverse (merge_in_descending_order (first sorted_a) (rest sorted_a) (first sorted_b) (rest sorted_b) ())))