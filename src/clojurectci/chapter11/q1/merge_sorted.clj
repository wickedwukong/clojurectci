...
(defn- add_remaing [merged_results current remaining]
	(concat (conj merged_results current) remaining))

(defn-  merge_in_ascending_order [current_a remaining_a current_b remaining_b merged_results]
	(cond 
		(nil? current_a) (add_remaing merged_results current_b remaining_b)
		(nil? current_b) (add_remaing merged_results current_a remaining_a)
